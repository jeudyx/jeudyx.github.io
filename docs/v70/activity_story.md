...
| `privacy`  | Integer corresponding to the privacy setting of this object                                     | int    |
...
To attach a photo to a story, the image must be uploaded via the Image resource (example: [Attach a photo to a status post story](#attach-a-photo-to-a-status-post-story)).
